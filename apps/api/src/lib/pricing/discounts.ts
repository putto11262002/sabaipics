...
/**
 * Get all discount tiers for UI display
 */
export function getDiscountTiers(): DiscountTier[] {
  return [
    { min: 50, max: 299, discount: 0, label: 'No discount' },
    { min: 300, max: 599, discount: 8, label: '8% off' },
    { min: 600, max: Infinity, discount: 17, label: '17% off' },
  ];
}
