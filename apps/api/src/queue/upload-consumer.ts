...
async function processUpload(
  ...
  return safeTry(async function* () {
    ...
    const eventSettingsCached = caches.eventSettingsByEventId.get(intent.eventId);
    const eventSettings =
      eventSettingsCached !== undefined
        ? eventSettingsCached
        : await ResultAsync.fromPromise(
            ...
            (cause) => {
              caches.eventSettingsByEventId.set(intent.eventId, null);
