//  SonyAPDiscovery.swift
//  SabaiPicsStudio
//
//  Sony AP-mode discovery helpers.
//

import Foundation

enum SonyAPDiscovery {
    ...
    static func candidateIPs(preferredIP: String? = nil) -> [String] {
        ...
        // 3) Known Sony defaults / common router defaults
    ...
    static func isSonyCameraName(_ name: String) -> Bool {
        let lower = name.lowercased()
        return lower.contains("sony") || lower.contains("ilce") || lower.contains("dsc")
    }
}
