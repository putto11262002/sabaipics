...
│   ├── images/
│   │   ├── single/              # 1 person photos
│   │   ├── multiple/            # 2-10 people
│   │   ├── crowd/               # 10+ people
│   │   ├── edge-cases/          # difficult angles, lighting, etc.
│   │   └── no-faces/            # photos with no faces
│   ├── labels.json              # Ground truth: { image, faceCount }
│   └── README.md
│
├── recognition/                 # Test set 2: Face recognition
│   ├── images/
│   │   ├── person-001/          # Multiple photos of same person
│   │   │   ├── photo-001.jpg
│   │   │   ├── photo-002.jpg
│   │   │   └── photo-003.jpg
│   │   ├── person-002/          # Different person
│   │   │   ├── photo-001.jpg
│   │   │   └── photo-002.jpg
│   │   └── mixed-groups/        # Photos with multiple known people
│   │       ├── group-001.jpg    # Contains person-001, person-002
│   │       └── group-002.jpg
│   ├── ground-truth.json        # Identity mapping & test queries
│   └── README.md
│
├── scripts/                     # Helper scripts
│   ├── label-detection.ts       # Label faces for detection tests
│   ├── label-recognition.ts     # Set up recognition test data
│   └── download-eval-data.ts    # Download test images from R2
│
└── README.md                    # This file
```
...
[
  {
    "image": "single/001.jpg",
    "faceCount": 1,
    "notes": "Clear front-facing photo"
  },
  {
    "image": "multiple/001.jpg",
    "faceCount": 5,
    "notes": "Group photo with good lighting"
  },
  {
    "image": "edge-cases/001.jpg",
    "faceCount": 2,
...
1. Organize images into category folders (single, multiple, crowd, edge-cases)
2. Count faces manually or use a trusted detector
3. Add to `detection/labels.json`:

```bash
# Interactive labeling tool
pnpm eval:label-detection

# Or manually edit detection/labels.json
```
