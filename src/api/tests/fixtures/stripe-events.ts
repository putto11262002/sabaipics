 ...
 */
export function createPaymentFailedEvent(overrides?: Partial<Stripe.PaymentIntent>): Stripe.Event {
 ...
 */
export function createCustomerCreatedEvent(overrides?: Partial<Stripe.Customer>): Stripe.Event {
 ...
 */
export function createCustomerUpdatedEvent(overrides?: Partial<Stripe.Customer>): Stripe.Event {
