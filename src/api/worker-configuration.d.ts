/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c wrangler.api.jsonc` (hash: ce8f71dcfc8cb6adf6d060708055e95c)
// Runtime types generated with workerd@1.20260212.0 2025-12-06 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/api/src/index");
	}
	interface StagingEnv {
		LINE_PENDING_KV: KVNamespace;
		PHOTOS_BUCKET: R2Bucket;
		PHOTO_PIPELINE_QUEUE: Queue;
		CLEANUP_QUEUE: Queue;
		LOGO_QUEUE: Queue;
		LUT_QUEUE: Queue;
		...
		CORS_ORIGIN: "https://app-staging.framefast.io,https://event-staging.framefast.io,https://admin-staging.framefast.io,http://localhost:5175";
		...
		CF_ACCESS_AUD: "505392355047ad894d5d55809c271e356dcfb45ba1123ed5ede28daf543e58d7";
		RECOGNITION_ENDPOINT: "https://putto11262002--framefast-recognition-serve.modal.run";
		MODAL_ORCHESTRATOR_URL: "https://putto11262002--framefast-orchestrator-process-batch.modal.run";
		POSTHOG_API_KEY: "";
		...
		PIPELINE_CALLBACK_TOKEN: string;
		DOWNLOAD_RATE_LIMITER: RateLimit;
		LUT_PREVIEW_RATE_LIMITER: RateLimit;
		SEARCH_RATE_LIMITER: RateLimit;
		LINE_FRIENDSHIP_RATE_LIMITER: RateLimit;
	}
	interface ProductionEnv {
		...
		CORS_ORIGIN: "https://app.framefast.io,https://event.framefast.io,https://admin.framefast.io";
	...
	interface Env {
		...
		DASHBOARD_FRONTEND_URL: "https://app-staging.framefast.io" | "https://app.framefast.io" | "http://localhost:5173";
		EVENT_FRONTEND_URL: "https://event-staging.framefast.io" | "https://event.framefast.io" | "http://localhost:5174";
		CORS_ORIGIN: "https://app-staging.framefast.io,https://event-staging.framefast.io,https://admin-staging.framefast.io,http://localhost:5175" | "https://app.framefast.io,https://event.framefast.io,https://admin.framefast.io" | "http://localhost:5173,http://localhost:5174,http://localhost:5175";
		AUTHORIZED_PARTIES: "https://app-staging.framefast.io,https://event-staging.framefast.io" | "https://app.framefast.io,https://event.framefast.io" | "http://localhost:5173";
		CF_ZONE: "framefast.io";
		PHOTO_BUCKET_NAME: "framefast-photos-staging" | "framefast-photos" | "framefast-photos-dev";
		PHOTO_R2_BASE_URL: "https://photos-staging.framefast.io" | "https://photos.framefast.io" | "https://photos-dev.framefast.io";
		RETENTION_DAYS: "30";
		CLEANUP_BATCH_SIZE: "10";
		HARD_DELETE_GRACE_DAYS: "30";
		HARD_DELETE_BATCH_SIZE: "5";
		CF_ACCESS_TEAM_DOMAIN: "https://framefast.cloudflareaccess.com";
		CF_ACCESS_AUD: "505392355047ad894d5d55809c271e356dcfb45ba1123ed5ede28daf543e58d7";
		RECOGNITION_ENDPOINT: "https://putto11262002--framefast-recognition-serve.modal.run" | "http://localhost:8082";
		MODAL_ORCHESTRATOR_URL: "https://putto11262002--framefast-orchestrator-process-batch.modal.run";
		POSTHOG_API_KEY: "";
		GRAFANA_LOKI_URL: "https://logs-prod-020.grafana.net";
		GRAFANA_OTLP_TRACES_URL: "https://otlp-gateway-prod-ap-southeast-1.grafana.net/otlp";
		GRAFANA_OTLP_METRICS_URL: "https://otlp-gateway-prod-ap-southeast-1.grafana.net/otlp";
		OTEL_TRACE_SAMPLE_RATIO: "0.60" | "0.50" | "1.0";
		DOWNLOAD_RATE_LIMITER: RateLimit;
		LUT_PREVIEW_RATE_LIMITER: RateLimit;
		SEARCH_RATE_LIMITER: RateLimit;
		LINE_FRIENDSHIP_RATE_LIMITER: RateLimit;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NODE_ENV" | "DASHBOARD_FRONTEND_URL" | "EVENT_FRONTEND_URL" | "CORS_ORIGIN" | "AUTHORIZED_PARTIES" | "CF_ZONE" | "PHOTO_BUCKET_NAME" | "PHOTO_R2_BASE_URL" | "RETENTION_DAYS" | "CLEANUP_BATCH_SIZE" | "HARD_DELETE_GRACE_DAYS" | "HARD_DELETE_BATCH_SIZE" | "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD" | "RECOGNITION_ENDPOINT" | "MODAL_ORCHESTRATOR_URL" | "POSTHOG_API_KEY" | "GRAFANA_LOKI_URL" | "GRAFANA_OTLP_TRACES_URL" | "GRAFANA_OTLP_METRICS_URL" | "OTEL_TRACE_SAMPLE_RATIO" | "API_BASE_URL" | "CLERK_SECRET_KEY" | "CLERK_PUBLISHABLE_KEY" | "CLERK_JWT_KEY" | "CLERK_WEBHOOK_SIGNING_SECRET" | "NGROK_DOMAIN" | "DATABASE_URL" | "FACE_PROVIDER" | "SABAIFACE_ENDPOINT" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "AWS_REGION" | "STRIPE_SECRET_KEY" | "STRIPE_WEBHOOK_SECRET" | "ADMIN_API_KEY" | "LINE_CHANNEL_SECRET" | "LINE_CHANNEL_ACCESS_TOKEN" | "LINE_LOGIN_CHANNEL_ID" | "LINE_LOGIN_CHANNEL_SECRET" | "APP_BASE_URL" | "CF_DOMAIN" | "R2_BASE_URL" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "CF_ACCOUNT_ID" | "FTP_PASSWORD_ENCRYPTION_KEY" | "FTP_JWT_SECRET" | "MODAL_KEY" | "MODAL_SECRET" | "LOKI_USER" | "LOKI_TOKEN" | "OTLP_TRACES_USER" | "OTLP_TRACES_TOKEN" | "GRAFANA_API_TOKEN" | "PIPELINE_CALLBACK_TOKEN">> {}
}
