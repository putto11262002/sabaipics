/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ../../wrangler.api.jsonc` (hash: d218a7474be30b79d25ef99d7826c601)
...
declare namespace Cloudflare {
  ...
  interface StagingEnv {
    ...
    MODAL_KEY: string;
    MODAL_SECRET: string;
    AWS_REKOGNITION_RATE_LIMITER: DurableObjectNamespace<
      import('./src/index').RekognitionRateLimiter
    >;
  ...
  interface Env {
    ...
    DASHBOARD_FRONTEND_URL:
      | 'https://app-staging.framefast.io'
      | 'https://app.framefast.io'
      | 'http://localhost:5173';
    EVENT_FRONTEND_URL:
      | 'https://event-staging.framefast.io'
      | 'https://event.framefast.io'
      | 'http://localhost:5174';
    CORS_ORIGIN:
      | 'https://app-staging.framefast.io,https://event-staging.framefast.io,https://admin-staging.framefast.io,http://localhost:5175'
      | 'https://app.framefast.io,https://event.framefast.io,https://admin.framefast.io'
      | 'http://localhost:5173,http://localhost:5174,http://localhost:5175';
    AUTHORIZED_PARTIES:
      | 'https://app-staging.framefast.io,https://event-staging.framefast.io'
      | 'https://app.framefast.io,https://event.framefast.io'
      | 'http://localhost:5173';
    CF_ZONE: 'framefast.io';
    PHOTO_BUCKET_NAME: 'framefast-photos-staging' | 'framefast-photos' | 'framefast-photos-dev';
    PHOTO_R2_BASE_URL:
      | 'https://photos-staging.framefast.io'
      | 'https://photos.framefast.io'
      | 'https://photos-dev.framefast.io';
    RETENTION_DAYS: '30';
    CLEANUP_BATCH_SIZE: '10';
    HARD_DELETE_GRACE_DAYS: '30';
    HARD_DELETE_BATCH_SIZE: '5';
    SENTRY_DSN:
      | 'https://fa797a451625d1341a655aabbc83ff6c@o4508085109850112.ingest.us.sentry.io/4510853502402560'
      | '';
    CF_ACCESS_TEAM_DOMAIN: 'https://framefast.cloudflareaccess.com';
    CF_ACCESS_AUD: '505392355047ad894d5d55809c271e356dcfb45ba1123ed5ede28daf543e58d7';
    AWS_REKOGNITION_RATE_LIMITER: DurableObjectNamespace<
