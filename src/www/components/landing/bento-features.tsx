    ...
    <div className="relative h-full w-full overflow-hidden rounded-2xl border border-border">
      ...
      <div className="absolute inset-x-0 bottom-0 flex flex-col gap-2 ps-2">
        {ways.map((way) => {
          const Icon = way.icon;
          return (
            <div key={way.label} className="flex items-center gap-3 bg-background px-4 py-2">
      ...
      <div className="absolute inset-x-0 top-0 z-10 bg-gradient-to-b from-card from-40% to-transparent p-5 pb-16">
        ...
        <p className="mt-1 text-muted-foreground">iOS WiFi, browser, desktop, or Lightroom.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative h-full w-full overflow-hidden rounded-2xl border border-border bg-card">
      ...
      <div className="absolute inset-x-0 top-0 z-10 bg-gradient-to-b from-card from-40% to-transparent p-5 pb-16">
        ...
        <p className="mt-1 text-muted-foreground">Share links that just work.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative h-full w-full overflow-hidden rounded-2xl border border-border bg-card">
      ...
      <div className="absolute inset-x-0 top-0 z-10 bg-gradient-to-b from-card from-40% to-transparent p-5 pb-12">
        ...
        <p className="mt-1 text-muted-foreground">Watermarks and styling that match your studio.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative h-full w-full overflow-hidden rounded-2xl border border-border bg-card">
                  ...
                  <div className="flex flex-col gap-0.5">
                    {[60, 80, 45, 90].map((h, i) => (
                      <div key={i} className="flex items-center gap-0.5">
                        <div className="h-1 rounded bg-primary/30" style={{ width: `${h}%` }} />
                      </div>
                    ))}
                  </div>
                </div>
      ...
      <div className="absolute inset-x-0 top-0 z-10 bg-gradient-to-b from-card from-40% to-transparent p-5 pb-12">
        ...
        <p className="mt-1 text-muted-foreground">Dashboard to manage events and track delivery.</p>
      </div>
    </div>
  );
}
  ...
  return (
    <section id="features" className="mx-auto max-w-7xl px-4 py-16">
      <div className="mb-10 max-w-3xl">
        ...
        <p className="mt-2 text-muted-foreground">From shoot to share, without the hassle.</p>
      </div>
