    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: 'linear-gradient(180deg, color-mix(in oklab, var(--primary) 25%, transparent) 0%, color-mix(in oklab, var(--primary) 12%, transparent) 50%, color-mix(in oklab, var(--primary) 25%, transparent) 100%)',
      ...
      <div
        ...
        style={{
          ...
          background: 'linear-gradient(145deg, color-mix(in oklab, var(--primary) 18%, transparent) 0%, color-mix(in oklab, var(--primary) 6%, transparent) 100%)',
          boxShadow: `
      ...
      >
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(145deg, color-mix(in oklab, var(--primary) 12%, transparent), color-mix(in oklab, var(--primary) 4%, transparent))',
            color: 'var(--primary)',
          }}
        >
          C
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(155deg, color-mix(in oklab, var(--primary-end) 28%, transparent) 0%, transparent 65%)',
          }}
        />
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ transformStyle: 'preserve-3d', transform: 'rotateX(12deg) rotateY(-18deg) rotateZ(4deg) translateZ(0px)' }}
      >
        <div className="absolute inset-0 rounded-full" style={{ background: 'linear-gradient(180deg, color-mix(in oklab, var(--primary) 15%, transparent) 0%, color-mix(in oklab, var(--primary) 7%, transparent) 50%, color-mix(in oklab, var(--primary) 15%, transparent) 100%)', boxShadow: 'inset 0 0 0 1px color-mix(in oklab, var(--primary) 12%, transparent)' }} />
        <div className="absolute inset-0 rounded-full border border-primary/15 backdrop-blur-md" style={{ background: 'linear-gradient(145deg, color-mix(in oklab, var(--primary) 12%, transparent) 0%, color-mix(in oklab, var(--primary) 4%, transparent) 100%)', boxShadow: 'inset 2px 2px 4px color-mix(in oklab, var(--primary-end) 18%, transparent), inset -1px -1px 3px color-mix(in oklab, var(--primary) 8%, transparent), 2px 4px 8px color-mix(in oklab, var(--foreground) 14%, transparent)' }}>
          <div className="absolute inset-[16%] rounded-full border border-primary/10" style={{ background: 'color-mix(in oklab, var(--primary) 3%, transparent)' }} />
          <div className="absolute left-1/2 top-1/2 flex h-[44%] w-[44%] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-primary/15 text-lg font-bold" style={{ background: 'linear-gradient(145deg, color-mix(in oklab, var(--primary) 8%, transparent), color-mix(in oklab, var(--primary) 3%, transparent))', color: 'var(--primary)' }}>C</div>
          <div className="absolute left-[10%] top-[8%] h-[35%] w-[40%] rounded-full" style={{ background: 'linear-gradient(155deg, color-mix(in oklab, var(--primary-end) 18%, transparent) 0%, transparent 65%)' }} />
        </div>
      </div>
      ...
      <div
        ...
        style={{ transformStyle: 'preserve-3d', transform: 'rotateX(12deg) rotateY(-18deg) rotateZ(4deg) translateZ(2px)' }}
      >
        <div className="absolute inset-0 rounded-full" style={{ background: 'linear-gradient(180deg, color-mix(in oklab, var(--primary) 15%, transparent) 0%, color-mix(in oklab, var(--primary) 7%, transparent) 50%, color-mix(in oklab, var(--primary) 15%, transparent) 100%)', boxShadow: 'inset 0 0 0 1px color-mix(in oklab, var(--primary) 12%, transparent)' }} />
        <div className="absolute inset-0 rounded-full border border-primary/15 backdrop-blur-md" style={{ background: 'linear-gradient(145deg, color-mix(in oklab, var(--primary) 12%, transparent) 0%, color-mix(in oklab, var(--primary) 4%, transparent) 100%)', boxShadow: 'inset 2px 2px 4px color-mix(in oklab, var(--primary-end) 18%, transparent), inset -1px -1px 3px color-mix(in oklab, var(--primary) 8%, transparent), 2px 4px 8px color-mix(in oklab, var(--foreground) 14%, transparent)' }}>
          <div className="absolute inset-[16%] rounded-full border border-primary/10" style={{ background: 'color-mix(in oklab, var(--primary) 3%, transparent)' }} />
      ...
      <div
        ...
        style={{ transformStyle: 'preserve-3d', transform: 'rotateX(12deg) rotateY(-18deg) rotateZ(4deg) translateZ(4px)' }}
      >
        <div className="absolute inset-0 rounded-full" style={{ background: 'linear-gradient(180deg, color-mix(in oklab, var(--primary) 15%, transparent) 0%, color-mix(in oklab, var(--primary) 7%, transparent) 50%, color-mix(in oklab, var(--primary) 15%, transparent) 100%)', boxShadow: 'inset 0 0 0 1px color-mix(in oklab, var(--primary) 12%, transparent)' }} />
        <div className="absolute inset-0 rounded-full border border-primary/15 backdrop-blur-md" style={{ background: 'linear-gradient(145deg, color-mix(in oklab, var(--primary) 12%, transparent) 0%, color-mix(in oklab, var(--primary) 4%, transparent) 100%)', boxShadow: 'inset 2px 2px 4px color-mix(in oklab, var(--primary-end) 18%, transparent), inset -1px -1px 3px color-mix(in oklab, var(--primary) 8%, transparent), 2px 4px 8px color-mix(in oklab, var(--foreground) 14%, transparent)' }}>
          <div className="absolute inset-[16%] rounded-full border border-primary/10" style={{ background: 'color-mix(in oklab, var(--primary) 3%, transparent)' }} />
      ...
      <div
        ...
        style={{ transformStyle: 'preserve-3d', transform: 'rotateX(12deg) rotateY(-18deg) rotateZ(4deg) translateZ(6px)' }}
      >
        <div className="absolute inset-0 rounded-full" style={{ background: 'linear-gradient(180deg, color-mix(in oklab, var(--primary) 15%, transparent) 0%, color-mix(in oklab, var(--primary) 7%, transparent) 50%, color-mix(in oklab, var(--primary) 15%, transparent) 100%)', boxShadow: 'inset 0 0 0 1px color-mix(in oklab, var(--primary) 12%, transparent)' }} />
        <div className="absolute inset-0 rounded-full border border-primary/15 backdrop-blur-md" style={{ background: 'linear-gradient(145deg, color-mix(in oklab, var(--primary) 12%, transparent) 0%, color-mix(in oklab, var(--primary) 4%, transparent) 100%)', boxShadow: 'inset 2px 2px 4px color-mix(in oklab, var(--primary-end) 18%, transparent), inset -1px -1px 3px color-mix(in oklab, var(--primary) 8%, transparent), 2px 4px 8px color-mix(in oklab, var(--foreground) 14%, transparent)' }}>
          <div className="absolute inset-[16%] rounded-full border border-primary/10" style={{ background: 'color-mix(in oklab, var(--primary) 3%, transparent)' }} />
      ...
      <div
        ...
        style={{ transformStyle: 'preserve-3d', transform: 'rotateX(12deg) rotateY(-18deg) rotateZ(4deg) translateZ(8px)' }}
      >
        <div className="absolute inset-0 rounded-full" style={{ background: 'linear-gradient(180deg, color-mix(in oklab, var(--primary) 15%, transparent) 0%, color-mix(in oklab, var(--primary) 7%, transparent) 50%, color-mix(in oklab, var(--primary) 15%, transparent) 100%)', boxShadow: 'inset 0 0 0 1px color-mix(in oklab, var(--primary) 12%, transparent)' }} />
        <div className="absolute inset-0 rounded-full border border-primary/15 backdrop-blur-md" style={{ background: 'linear-gradient(145deg, color-mix(in oklab, var(--primary) 12%, transparent) 0%, color-mix(in oklab, var(--primary) 4%, transparent) 100%)', boxShadow: 'inset 2px 2px 4px color-mix(in oklab, var(--primary-end) 18%, transparent), inset -1px -1px 3px color-mix(in oklab, var(--primary) 8%, transparent), 3px 5px 10px color-mix(in oklab, var(--foreground) 18%, transparent)' }}>
          <div className="absolute inset-[16%] rounded-full border border-primary/10" style={{ background: 'color-mix(in oklab, var(--primary) 3%, transparent)' }} />
          <div className="absolute left-1/2 top-1/2 flex h-[44%] w-[44%] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border border-primary/15 text-lg font-bold" style={{ background: 'linear-gradient(145deg, color-mix(in oklab, var(--primary) 8%, transparent), color-mix(in oklab, var(--primary) 3%, transparent))', color: 'var(--primary)' }}>C</div>
          <div className="absolute left-[10%] top-[8%] h-[35%] w-[40%] rounded-full" style={{ background: 'linear-gradient(155deg, color-mix(in oklab, var(--primary-end) 18%, transparent) 0%, transparent 65%)' }} />
        </div>
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(180deg, color-mix(in oklab, var(--primary-end) 25%, transparent) 0%, color-mix(in oklab, var(--primary-end) 12%, transparent) 100%)',
          }}
        >
          {/* Sun */}
          <div
            ...
            style={{
              background: 'radial-gradient(circle, color-mix(in oklab, var(--primary-end) 40%, transparent) 0%, transparent 70%)',
            }}
          />
          {/* Mountains with curves */}
          <svg className="absolute bottom-0 left-0 h-full w-full" viewBox="0 0 44 36" preserveAspectRatio="none">
            {/* Back mountain */}
            <path
