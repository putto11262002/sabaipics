This is the default issue template (Bug Report), if you wish to create a different type of issue, please [choose the type of issue](https://github.com/simonmitchell/rocc/issues/new/choose) to submit.
